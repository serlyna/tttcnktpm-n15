...
<head>
    ...
    <link rel="stylesheet" href="css/flatiron.css" type="text/css">
    <link rel="stylesheet" href="css/braille.css" type="text/css">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text" style="height:450px;">
                                <h2>𝕎𝕒𝕣 𝕋𝕙𝕦𝕟𝕕𝕖𝕣 </h2>
                                <img src="./img/blog/qr1.png" style="width:220px; margin-left:32%">
                                <br>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="about__text">
                        <div class="section-title">
                            <span style="color:#0b243b">About War Thunder</span>
                            <h2>Những cuốn sách tốt nhất có sẵn với giá tốt nhất!</h2>
                        </div>
                        <p>"War Thunder" là một tiệm sách nhỏ, khởi đầu là một doanh nghiệp nhỏ.</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="class__form">
                        <div class="section-title">
                            <span style="color:#0b243b"> War Thunder</span>
            ...
            <div class="row">
                <div class="col-lg-4 p-0">
                    <div class="instagram__text">
                        ...
                        <h5><i class="fa fa-instagram"></i> @lasaota2002</h5>
                        <h5><i class="fa fa-instagram"></i> @lasaota2002</h5>
                    </div>
                </div>
                <div class="col-lg-8">
