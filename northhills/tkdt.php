...
if (isset($_POST['display'])){
        ...
        $query=mysqli_query($con," select * from donhang")or die(mysqli_error($con));
        $total=0;
        
        echo "<h2 style='text-align:center'><b>Monthly Sales</b></h2>";
        while($row=mysqli_fetch_array($query)){
            $total=$total+$row['donhang'];	
...
?>
        ...
        <tr>
            ...
            <td class="text-right"><b><?php echo number_format($row['donhang'],2);?></b></td>
        </tr>
<?php }
    echo "<tr>
            <th><h2>TOTAL</h2></th>
