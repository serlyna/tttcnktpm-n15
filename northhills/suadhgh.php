...
if(isset($submit)){
    ...
    $mdm=$_REQUEST['id'];
    $sql = "Update donhang set tinhtrang = '$danhmuc' where madh='$mdm'";
...
<html>
    ...
    <body>
        ...
        <div class="noidung" style="height: 400px;">
                ...
                <form method="POST" >
                    <h1 style="margin-left: 310px;margin-top: 30px; margin-bottom: 10px;color: #f46523">CẬP NHẬT TÌNH TRẠNG ĐƠN HÀNG</h1>
                    <fieldset style="margin-left:330px; margin-top: 20px;"> 
                        <h4 style="margin-bottom: 10px;">Trạng thái</h4>
                    <input class="tx" type="text" id="s" style="width:90%; height:50px ; margin-left: 5px;" name="danhmuc" value="" placeholder="Trạng thái"/></br></br>
